...
<h2>Description</h2>
This project is about how to create a free VPN server in AWS cloud. This is a cost effective way to save money and provide much needed security when browsing on the internet, gives you a secure way to connect to your virtual private cloud in AWS using private ip addresses There is a step by step guide on how to build the VPN server successfully and test it, in order to make sure that it is working correctly.
<br />
